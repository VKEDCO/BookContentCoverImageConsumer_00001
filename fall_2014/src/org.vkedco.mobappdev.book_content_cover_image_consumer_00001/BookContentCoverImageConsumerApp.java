...
public class BookContentCoverImageConsumerApp extends Application {
    ...
    void saveBookCoverImagesInCache(Cursor rslt) {
		if ( rslt == null ) return;
    ...
    void saveSingleBookCoverImageInCache(Cursor rslt) {
    	saveBookCoverImagesInCache(rslt);
    }
    
    Bitmap getBitmap(String isbn) {
    	return mCoverImages.get(isbn);
    }
